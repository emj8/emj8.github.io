...
- __Handling missing values:__ Some restaurants were dropped since their pages do not offer daily working hours.
...
### Baseline Model
An Ordinary Least Squares (OLS) model was created using only the numerical features to estimate the initial values of the parameters of the Linear Regression Model. 
### Feature Engineering 
